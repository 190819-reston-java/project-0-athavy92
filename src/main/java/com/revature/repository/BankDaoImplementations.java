...
public class BankDaoImplementations implements BankDao {
	...
	private static Customer createCustomerFromRS(ResultSet results) throws SQLException {
		return new Customer(results.getInt("account_id"), results.getString("first_name"),
				results.getString("username"), results.getString("password"), results.getInt("pin_number"),
